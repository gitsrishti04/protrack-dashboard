...
import { progressOverTime, resourceUsage, teamWorkload } from "@/data/mockData";
...
export function WorkloadPieChart() {
  return (
    <div className="bg-card rounded-2xl border border-border p-5 shadow-sm">
      ...
      <ResponsiveContainer width="100%" height={260}>
        <PieChart>
          <Pie data={teamWorkload} cx="50%" cy="50%" outerRadius={90} innerRadius={50} dataKey="value" nameKey="name" paddingAngle={3} strokeWidth={0}>
            {teamWorkload.map((_, i) => (
